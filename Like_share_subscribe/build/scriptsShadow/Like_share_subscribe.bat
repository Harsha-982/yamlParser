...
set CLASSPATH=%APP_HOME%\lib\Like_share_subscribe-1.0-SNAPSHOT-all.jar

@rem Execute Like_share_subscribe
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LIKE_SHARE_SUBSCRIBE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
