...
set CLASSPATH=%APP_HOME%\lib\GradleShadowPlugin-1.0-SNAPSHOT-all.jar

@rem Execute GradleShadowPlugin
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GRADLE_SHADOW_PLUGIN_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
